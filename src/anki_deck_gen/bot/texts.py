...
HELP = (
    ...
    "3️⃣ текстом: одна строка — одна карточка, «вопрос / ответ».\n"
    "Присылайте хоть все сразу, хоть по одной — бот копит их, пока не нажмёте «Готово».\n\n"
...
VERDICT_IMPORT_HINT = (
    ...
    "На телефоне сначала сохраните его и откройте из «Файлов»: прямо из чата "
    "AnkiDroid берёт файл текстовым импортёром и ругается."
)

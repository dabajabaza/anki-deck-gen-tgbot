...
HELP = (
    ...
    "• файлом .xlsx или .csv;\n"
    "• ссылкой на Google Таблицу — откройте доступ «всем, у кого есть ссылка»;\n"
    "• текстом, по строке на карточку: «вопрос — ответ».\n\n"
...
FIX_STILL_NO_SEPARATOR = (
    "Всё ещё не вижу разделителя. Формат: «вопрос — ответ». /skip — пропустить."
)
...
ERR_UNSUPPORTED = (
    ...
    "или текст «вопрос — ответ» по строке (минимум две строки). /help — подробнее."
)
